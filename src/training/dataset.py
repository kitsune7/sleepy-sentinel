...
Avoid creating train/test splits here. Splitting belongs in `training.splits`;
this module should only turn already-split DataFrames into model-ready objects.
"""
